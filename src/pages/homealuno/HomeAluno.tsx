    ...
    return (
        <div className="bg-[#08060D]">
            <div className="min-h-screen bg-[#08060D] text-white">
                ...
                <section
                    id="cronograma"
                    className="relative overflow-hidden bg-[#08060D] px-6 py-20"
                >

                    <div className="pointer-events-none absolute left-0 top-1/3 h-72 w-72 rounded-full bg-violet-700/30 blur-[120px]" />
                    <div className="pointer-events-none absolute right-0 bottom-0 h-80 w-80 rounded-full bg-purple-600/20 blur-[130px]" />
                ...
                {/* FICHA */}
                <section className="relative overflow-hidden bg-[#08060D] mb-3 px-6 pb-30">

                    <div className="pointer-events-none absolute -left-20 bottom-0 h-92 w-92 rounded-full bg-violet-700/50 blur-[120px]" />
                    <div className="pointer-events-none absolute right-0 top-0 h-64 w-64 rounded-full bg-purple-600/50 blur-[110px]" />
                            ...
                            <div className="mt-3 grid gap-3 sm:grid-cols-3">
                                ...
                                {OBJETIVOS.map((op) => (
                                    ...
                                    >
                                        ...
                                        <p
                                            className={`mt-0.5 text-sm ${objetivo === op.id
                                                ? "text-violet-400"
                                                : "text-slate-500"
                                                }`}
                                        >
